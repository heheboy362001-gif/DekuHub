...
local GUI = New("ScreenGui", {
	...
	Name = "Hu1a0UI", -- đặt tên rõ ràng (có thể tuỳ chỉnh)
})
Library.GUI = GUI
ProtectGui(GUI)
...
local SaveManager = {} do
	SaveManager.Folder = "Hu1a0Settings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "Hu1a0Settings"
